...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Not all zombies are near-mindless, shambling corpses. The einherjar are one such breed of zombies. In Norse mythology, the einherjar were Odin\'s eternal warriors, mortals who had earned a seat in Valhalla. Necromancers could petition Odin for use of the einherjar, though on Earth they appear as zombies rather than “live” warriors. They are renowned for their strength and courage.\nIn a fantasy horror game, a god of battle might have similar undead followers he loans to favored mortals. For a modern game, perhaps the ancient Norse gods are not completely dead and can still make their presence felt on Earth.\nEinherjar can speak, though traditional ones only speak Old Norse. A character with knowledge of any Scandinavian language can make a Common Knowledge (if it\'s his native tongue) or Knowledge (Language) to communicate with them.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Fearless: Immune to Fear and Intimidation. •Fleet Footed: Skeletal horses roll a d8\nwhen running, rather than a d6.\nKick: Str+d6.\nSize +2: Skeletal horses stand taller than a\nhuman and weigh as much as 500 pounds. •Undead: +2 Toughness; +2 to recover from being Shaken; no additional damage from Called Shots; immune to disease and poison.',
		},
		tags: {
			'en-US' : '',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Armor +3: Chitinous shell.\nBite: Str+d6.\nFear (-4): Anyone seeing the creature must make a Fear check at -4.\nFearless: Immune to Fear and Intimidation. •Gargantuan: Heavy Armor. Creatures add +4 when attacking the body of Arachnos due to her great size. Add Size to damage when crushing but subtract the Size of the victim.\nHardy: If Shaken, further Shaken results have no effect.\nImproved Arcane Resistance: +4 Armor versus magic, and +4 to rolls made to resist magic effects.\nPoison (-4): The bite of the spider causes instant death for those who fail a Vigor roll. •Regeneration (Slow): Arachnos makes a natural healing roll every day.\nSize +10: Arachnos is over 60\' across.\nSwarm: Each round, Arachnos may release a swarm of her young. These  ll a Large Burst Template. Use the Swarm stats. She may release a maximum of 10 swarms. If a swarm is killed, she births more young at the rate of one swarm per week.\nWebbing: Arachnos can cast webs from her thorax that are the size of Large Burst Templates. This is a Shooting roll with a range of 10/20/40. Anything in the web must cut or break their way free (Toughness 7 per 1”). Webbed characters can still  ght, but all physical actions are at -4.',
		},
		tags: {
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Although often referred to as “the” Dark Man, evidence suggests that this creature is not a unique entity. A dark man, is a humanoid  gure of inky darkness with no visible facial features.\nA dark man is a source of pure necromantic energy, and its power lies in its ability to boost undead. As such, they are never summoned except to “lead” a host of such  ends. Their abilities work on Wild Card undead as well as Extras.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Fanatical: Minions go berserk, as per the Edge, if they see their master take a wound. •Lame: Minions roll a d4 running die instead of a d6.\nSize -1: Minions are usually stunted or twisted.',
		},
		tags: {
			'en-US' : '',
		},
		...
		blurb: {
			'en-US' : 'Every mad scientist or cult leader has a trusty sidekick, and they\'re usually deformed in some way. Deformed minions are fanatically loyal to their master.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'When first encountered, dismembered corpses look exactly like zombies. However, after they take their first wound, they  y apart into four limbs, a torso, intestines, and a head�"each acting as an independent entity.\nThe various parts  oat around the torso, but operate completely independently. These various bits  ail, slap, kick, and claw at their bewildered foes.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Dread liches are those foul beings who have “lived” for centuries, refining and honing their mastery of the dark arts. Aside from having greater magic and enhanced control over lesser undead than liches, dread liches can avoid destruction by transferring their essence to lesser undead.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'At certain times of the year, evil holds great sway. All Hallows Eve is one such occasion, but there are others. During this time, creatures born in sleepers\' nightmares gain the power to enter the physical world.\nTheir exact form varies from sleeper to sleeper. Some take the form of demonic clowns, others as tentacled beasts or maniacal versions of abusive parents. Regardless of form, all are intent on manifesting in the physical world and causing as much mayhem as possible.\nDream evils materialize after their host has gone to sleep, generally appearing within a few miles and proceed to act something like what they\'ve manifested as. A giant spider lurks in trees and ensnares victims, however. An evil clown might appear near a circus and lure attendees into a dark tent where it can devour them.\nDream evils never attack their host�"that automatically ends their existence. The only way to be rid of them is to survive seven straight nights without sleep, or via the banish entity power.\nDream evils have physical statistics based on their form. Their Smarts and Spirit are equal to the Spirit of the host. They also have the following Special Abilities.\n',
		},
		attributes: '{"agility":"","smarts":"","spirit":"","strength":"","vigor":""}',
		skills: '[]',
		wildcard: 1,
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Dreamreavers are spirits of nightmare that walk the mortal world looking for victims\' psyches to feed upon. They do so by plunging the victim into a terrible and all-too-real dream world. Within, the dreamer must battle to complete some quest, overcoming obstacles and defeating foes, or remain lost in the nightmare land forever.\nDreamreavers often pull close companions of their victims into the nightmare realm as well. This means an entire party might find themselves trapped in one of their companions\' nightmares.\nOnce in the dream world, the victim soon stumbles upon some quest that he feels compelled to complete. The task may be simple escape, it may be to defeat a dread foe, or it may to reach some distant objective.\nThe foes and obstacles faced along the way are very real (within the dream world, anyway), and should be handled just as in regular play.\nVictims who die within the dream world remain in a coma in the physical world. They are essentially brain dead�"the dreamreaver has devoured their essence.\nThose who survive and “win” dispel the dreamreaver and are blessed with restful sleep for the rest of their lives. If they suffered from night terrors or other sleep disorders before, they are cured. They may still have occasional nightmares, but are always aware they are nothing but dreams and ignore any ill effects.\nThe statistics below are for the dreamreaver\'s invisible spirit form. Those who can see such things spy a squat, toad-like humanoid with black eyes, lolling tongue, and vacant, slack- jawed gaze.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Dark Emotion: The spirit attaches itself to a single victim and stays within a few feet for the duration of its “life.” While present, it enhances the host\'s negative emotions. A peaceful man might become angry or short-tempered, while a naturally angry man likely becomes violent.\nEthereal: Invisible and immune to normal damage. Magic items, weapons, and supernatural powers affect them normally.\nExorcism: An emotion spirit can be made  esh by a banish entity spell. If destroyed in that state, it vanishes forever.',
		},
		tags: {
			'en-US' : '',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'That irrational fear you have of clowns isn\'t always irrational. Below is a common version of the evil clown�"the kind that lures victims into the dark and devours them.\nA gaggle of clowns have the statistics listed below. A single clown�"or sometimes a “boss clown”�"is a Wild Card.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Fetches are spiritual companions to mortals who can detect spirits and other ethereal beings. Traditionally, only people born on a Saturday could have a fetch dog, but this may vary depending on the setting and your particular lore. In a game setting, fetch\'s are probably better suited to be gifts from powerful friendly entities.\nThe “owner” of a fetch cannot communicate with it�"the thing simply stays by its companion at all times, protecting its master from evil to the best of its ability. It cannot affect the physical world in any way.\nFetches are invisible, but occasionally�"at the Game Master\'s discretion�"mortals might catch a glimpse of the creature.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Pumpkin Jack is probably the most famous foul scarecrow, but he isn\'t the only one of his kind. Foul scarecrows are most commonly awakened by evil spirits, but sometimes the spilling of blood can awaken them. Old battle fields now turned over to agriculture are good candidates.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Ethereal: Hates are immune to normal attacks. Magic items, weapons, and supernatural powers affect them normally.\nFear: Anyone seeing the creature must make a Fear check.\nFearless: Immune to Fear and Intimidation. •Rage: A hate  fills a Large Burst Template. Any character in the template must make an opposed Spirit roll. On a failure, the victim goes berserk (as the Edge) and launches a violent attack against the nearest character, friend or foe. The character may try to end his rage as normal, but must succeed at an opposed Spirit roll rather than making a Smarts roll as normal.\nSwarm: Parry +2. Because the hate is composed of scores, hundreds, or thousands of souls, cutting and piercing weapons do no real damage. Area-effect weapons work normally.',
		},
		tags: {
			'en-US' : '',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Haunted cars (or other vehicles) are possessed by evil machine spirits who “feed” by mangling victims within them.\nHaunted cars are sentient and malevolent. They\'re also conscious of being destroyed and so know to maintain a low profile�"when they aren\'t on a murderous rampage.\nUse the statistics for the car in question, but add Smarts at d8 and Spirit at d10 for the spirit inside, as well as the Special Abilities listed below. Track the car\'s wounds just as you would any other vehicle. If it\'s “wrecked,” it\'s treated as Incapacitated.\nHaunted cars control themselves, but like to toy with their victims for a while before feasting on their shattered bodies. This process may go on for several days or even weeks if the car becomes fond of a particular operator. When this happens, which it often does, the machine spirit “falls in love” with the driver, killing at night or when the operator isn\'t present to avoid the temptation of devouring him or her instead. Such spirits often become very jealous of others who compete for their operator\'s attention.',
		},
		attributes: '{"agility":"","smarts":"","spirit":"","strength":"","vigor":""}',
		skills: '[]',
		wildcard: 0,
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'A haunted portrait is a painting possessed by a malevolent spirit�"typically a shade or shadow of the person depicted.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Hellhounds are monstrous dogs, often with black skin which steams from the heat of the beast\'s demonic blood. Their eyes burn with demonic  re and their teeth are oversized, protruding from their jaw at all angles. Certain demons often keep them as pets, though they may also be found in the company of necromancers and other evil wizards. They are sometimes known as “black dogs.”',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'The homunculus is the result of an alchemist successfully crafting a living creature using his art. These creatures are tiny, man-shaped, and sometimes take on the rough appearance of their creators. The recipes for homunculi vary from alchemist to alchemist and often vary greatly. However, all have one thing in common: even though they are somehow granted a spark of life, these strange constructs lack a soul.\nThis fact makes homunculi extremely dangerous for they are perfect vessels for demonic or other types of spiritual possession. Few escape falling prey to the attentions of fell beings, often within hours�"or even minutes�"of their creation. Ironically, since most alchemists fancy themselves scientists rather than magicians, the majority of them scoff at the possibility of such an event.\nWhile in service of their creator, these creatures are typically used for innocuous purposes, or at worst, to spy on others. Under the control of a malevolent spirit, they become focused on mischief and mayhem�"or far worse.\nInitially, the appearance of these small constructs depends largely on the ingredients used in their manufacture. Some appear plant-like, while others may vaguely resemble lizards or other reptilian creatures. Over time, they may take on more human features as they bond to their creator�"or more demonic ones if they succumb to diabolic influences.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Aquatic: Pace 6\nBite or Claws: Str+d4\nBlood Frenzy: When another character or animal suffers a wound, all icthynites and hybrids within 6” are driven into a frenzy by the scent of blood. This causes them to go Berserk (as per the Edge). Unlike their full-blooded cousins, a hybrid can attempt to end his rage by doing nothing (even moving) for a full action and making a Smarts roll (-2).\nCrooning: A hybrid\'s vocal cords aren\'t developed enough to initiate the icthynites\' hypnotic song. However, as an action, it can lend its voice to the chorus and counts as an additional icthynite for purposes of penalties to the Spirit roll to resist the crooning.\nLow Light Vision: Icthynite hybrids ignore any penalties for Dim and Dark lighting.',
		},
		tags: {
			'en-US' : '',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Break the Hold: The only way a mortal can be freed of the leanhaum-shee\'s seductive grasp is to  nd a replacement �" or the creature\'s death.\nEnslave: A leanhaum-shee uses her seductive charms to enslave mortals. This works as puppet using the leanhaum-shee\'s Spirit as her arcane ability, but it lasts inde nitely. She adds her Charisma to this roll. A leanhaum-shee may only ever have one mortal bound to her at a time.\nLife Drain: Each week a slave remains enthralled, regardless of the distance between mistress and slave, he must make a Spirit roll or lose one die from his Vigor. When his Vigor drops below a d4, he dies. One die of Vigor is recovered with a natural healing roll made each week if the leanhaum-shee\'s hold over the slave is broken.\nUnearthly Beauty: A leanhaum-shee is incredibly beautiful and has +8 Charisma.',
		},
		tags: {
			'en-US' : '',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'While it\'s doubtful many demon lords have libraries, these unusual demons are the scholars of the underworld. The epithet, perhaps given in jest, has become common parlance.\nLibrarians are tall, blue-skinned humanoids with red eyes. Their heads are completely bald, and runes of power and knowledge are burned into their skull. When traveling in mortal realms, they wear heavy cowled cloaks to conceal their appearance.\nUnusually for a denizen of Hell, librarians seem quite willing to help mortals in return for a small reward, such as a relic or a tome of knowledge. What use they have for these items in Hell is anyone\'s guess.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Grimoires are books containing dark knowledge or spells. Most are simply books, though they may be written in blood or contain images that turn even the strongest stomach. Living grimoires, however, are magical creations, designed to protect the book from nosy individuals.\nLiving grimoires are actually just the covers of the book they hold. Usually they take the form of demonic faces, gaping maws, or perhaps just sharp claws used to clasp the book closed. They only make their presence felt when someone other than the book\'s rightful owner tries to pick up or open the book. Killing the grimoire does not damage the book (a by-product of the magic used in their creation).\nLiving grimoires speak many languages, but usually only converse to threaten or taunt people.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Bite: Str+d4.\nFear: Anyone seeing the creature must make a Fear test.\nFleet-Footed: A man-dog hybrid running on all fours has a d10 running die.\nGo for the Throat: A hybrid scoring a raise on its attack roll automatically hits the target\'s most weakly-armored location.',
		},
		tags: {
			'en-US' : '',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Armor +2: Wooden body.\nConstruct: +2 to recover from being Shaken; No additional damage from called shots; Do not suffer wound modifiers; Immune to poison and disease.\nFearless: Golems are immune to Fear and Intimidation.\nSize -1: Marionettes stand no taller than 2\'. •Small: Attackers suffer a -2 penalty when attacking a marionette.',
		},
		tags: {
			'en-US' : '',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Those unfortunate souls sprayed with Todoto\'s blood become twisted and warped. No two forms are the same. Some may grow extra limbs or tentacles while others turn inside out, transforming into an unholy blend of man, plant, and animal. Still others might become putrescent blobs of gelatinous ooze.\nMinions are loyal to Todoto, though he has no special powers to control their actions.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Claws: Str+d6.\nDemon: +2 to recover from being Shaken;Immune to poison and disease; Half- damage from non-magical attacks except for cold iron.\nFear: Anyone seeing the creature must make a Fear test\nFlight: Flying Pace 12”, Climb 3”. •Illusionary Appearance: Pazuzu can assume the form of a human (or nonhuman if your setting allows such races). •Improved Frenzy: A pazuzu in the air may make two Fighting attacks each round at no penalty.\nSize +2: Pazuzu stand over 9\' high in their natural form.\nUntrickable: Pazuzu are masters of deception and are not subject to Tests of Will.\nWeakness (Cold Iron): Demons take normal damage from cold iron weapons.',
		},
		tags: {
			'en-US' : 'demon,demons,devil,devils,',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Rabies is a disease of the central nervous system and can be found in any warm-blooded animal. In the real world, it tends to be found in smaller animals, such as bats or raccoons, but in a horror game there\'s no reason why a larger creature can\'t have the disease.\nTo make a rabid animal, simply add the Berserk, Disease, Fearless, and Weakness (Water) abilities as shown below in the sample creature.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Unlike in real life, serial killers in most horror settings aren\'t the quiet-guy- next-door type. Horror setting serial\nkillers stand out in a crowd, mainly because of their strange attire, blood-soaked clothes, and large, dangerous weapons.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'The “king of the dinosaurs” was no doubt a terrifying creature when it roamed the Earth. As a skeletal creature, it\'s even more fearsome.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Many movies depict zombies as having an insatiable craving for human brains. Some of these zombies can speak, though usually their vocabulary is limited to one word�" “Brains!”�"which they moan continually when they spy a potential meal.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Corrupting Lyrics: Every time a person listens to a tainted musician\'s songs, he must make a Spirit roll (at -2 for a live performance). Failure means the listener loses 1 point of Sanity and gains a negative Hindrance of the Game Master\'s choice, such as Bloodthirsty, Greedy, or Mean. These get progressively worse as time goes on until the listener is driven insane. This typically results in acts of violence and mayhem.\nHeadbang: The musician can headbutt for Str+d6 damage.\nPacify: Tainted musicians often find themselves surrounded by angry listeners. To protect themselves, they play slow songs, odes, or power ballads that pacify those trying to attack them. If the musician takes a full defense maneuver, anyone desiring to harm him must win an opposed Spirit roll. With a raise, the attacker is immune to the musician\'s defense for the rest of the encounter.',
		},
		tags: {
			'en-US' : '',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'The nerd may be the brains of the out t, but he\'s a social pariah. His bookish knowledge might save his friends\' lives, but his nerdy glasses and lack of social skills mean they don\'t want to hang with him socially.',
		},
		attributes: '{"agility":"","smarts":"","spirit":"","strength":"","vigor":""}',
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'Abhorrent as it may be, people sometimes resort to cannibalism when lost in the wilderness or stranded on deserted islands.\nFor most, it is a matter of survival, never to be tried again once they are rescued. For a few, however, it becomes a craving. These individuals are said to be possessed by the spirit of the wendigo, an American Indian cannibal spirit.\nTrue wendigos are either more advanced forms of their lesser cousins or born from more savage stock or circumstances. They tend to exist in the dead of winter, but there\'s no reason such creatures\ncan\'t exist in other climates.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Armor +4: Gelatinous body.\nFear (-4): Anyone seeing the creature must make a Fear check at -4.\nFearless: Immune to Fear and Intimidation. •Gargantuan: Heavy Armor. Creatures add +4 when attacking the body of Vralkresh due to its great size. Add Size to damage when crushing but subtract Size of victim.\nHardy: If Shaken, further Shaken results have no effect.\nImproved Arcane Resistance: +4 Armor versus magic, and +4 to rolls made to resist magic effects.\nImproved Frenzy: Vralkresh makes two Fighting attacks against every opponent within 2” of him each round without incurring a multi action penalty.\nRegeneration (Fast): Vralkresh makes a natural healing roll every round.\nSize +12: Vralkresh is over 100\' wide. \nTentacles: Str+d8. Each tentacle has a single wound, but damaging a tentacle causes no harm to Vralkresh. Vralkresh can sprout a new tentacle to replace a damaged one as a free action.',
		},
		tags: {
			'en-US' : 'dark gods,gods,god,',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'War droids are bipedal constructs, but due to their skeletal appearance (which is designed to instill fear) cannot be mistaken for humans. Their sole function is to destroy whatever life- form they\'ve been programmed to see as their enemy. They can use any standard weapons available to the race which built them.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Aquatic: Pace 10.\nBite: Str+d8.\nFeeding Frenzy: Once there\'s a significant amount of blood in the water (usually one wound), weresharks go into a feeding frenzy and add +2 to their attacks and damage for the rest of the  ght.\nImmunity: Were-creatures can only be Shaken by weapons that are not silver�"not wounded.\nInfection: Anyone bitten by a wereshark and suffers a wound or greater must make a Vigor roll. Failure means the character becomes a wereshark at the next full moon (assuming he survives the attack).\nSize +1: Weresharks stand over 7\' tall. •Weakness (silver): Were-creatures suffer\nnormal damage from silver weapons.',
		},
		tags: {
			'en-US' : '',
		},
		...
		blurb: {
			'en-US' : 'Weresharks are a human-shark mix. Like all werecreatures, they have a humanoid form with bestial features. In this instance, the creatures has a shark\'s head and skin, webbed hands, and a dorsal  n.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		abilities: {
			'en-US' : 'Ethereal: Will o\' wisps are immaterial. They don\'t suffer additional damage from called shots; Fearless; Immune to disease and poison.\nFlaming Jack: The will o\' wisp can reanimate and possess the body of a victim slain by its Spiritual Exhaustion (see below) attack.\nFlight: The will o\' wisp  flies at a rate of 8”. They may not “run.”\nFocus: The ghost is tied to a specific talisman�"usually a piece of jewelry�" which remains unnaturally hot to the touch (2d6 damage to exposed flesh). If this item is submerged in water, the will o\' wisp suffers 2d6 damage per round as long as it remains so. If it is submerged in holy water, the wisp is destroyed immediately.\nInvulnerability: Will o\' wisps are immune to all non-magical attacks, but suffer 1d6 damage when doused in at least a gallon of water, +2 per additional gallon.\nSpiritual Exhaustion: A will o\' wisp\'s only means of attack in its initial form is by subjecting its victim to a supernatural heat that only she can feel. The wisp and its target make an opposed Spirit roll. If the victim loses, the victim suffers a Fatigue level.\nSize -1: Will o\' wisps are approximately 2\'-3\' in diameter.\nWeakness (Holy Water): Sprinkling a will o\' wisp with holy water does 2d10 damage to it.',
		},
		tags: {
			'en-US' : '',
		},
		...
		blurb: {
			'en-US' : 'Will o\' wisps are the ghosts of witches and necromancers who have been burned at the stake. They manifest as small handfuls of  flickering white flame that is oddly cold to the touch rather than hot. Legend claims a brave observer can see a grinning face inside of a will o\' wisp.\nA will o\' wisp uses the glimmering light produced by its form to lure its intended victim to a secluded spot. There, it weakens the poor soul with a  re that seems to spring from Hell itself. Once its target succumbs to the heat, the ghost possesses his corpse which immediately bursts aflame. These burning zombies are sometimes referred to as “flaming jacks,” particularly among more rural populations. The ghost uses the reanimated body to wreak as much havoc as it can before it is consumed by the creature\'s otherworldly  ames�"preferably on those it believes wronged it in its former life.\nInitially, a will o\' wisp haunts the area near its death, seeking vengeance on those responsible for any and all wrongdoings against it during life. However, even once it has revenged itself on everyone guilty of even the slightest infraction, the hatred and anger that drove it to an undead existence continues to burn within the ghost. Eventually, these spirits tend to gravitate toward lonely, desolate areas where their unnatural spite for all things living leads them to prey upon unsuspecting travelers.\nThe process by which a will o\' wisp is formed is a closely guarded secret among the few practitioners of the dark arts that know it and often varies greatly in the details. Invariably though, it involves the creation of a talisman of some sort which must be on the black magician at the time of his death and which serves as the ghost\'s anchor to this plane. The talisman is not consumed in the  ames, but remains ever after searing hot to the touch.\nThe light of a will o\' wisp varies from cold white to  flame orange. The ghost can lessen its brilliance to that of a mere candle or brighten it to that of a torch at will.',
		},
...
savageWorldsExtrasDatabase = savageWorldsExtrasDatabase.concat(
	{
		...
		blurb: {
			'en-US' : 'There are many types of witches in horror tales�"from classic crones making deals with the devil to modern divas who practice (cinematic) wicca. Where they draw their power from and what they do with it is typically the feature of your tale.',
		},
		attributes: '{"agility":"d6","smarts":"d8","spirit":"d8","strength":"d6","vigor":"d6"}',

...
var vehicle_weapons = Array(
	...
	{
		name: "Particle Accelerator, Light",
		name_plural: "Particle Accelerators, Light",
		classification: "Particle Accelerators",
		description: "Vehicular blasters fire a stream of charged particles (ions). Because the weapon fires a stream, a raise on the attack roll causes +2d6 damage instead of the usual 1d6. ",
		range: "100/200/400",
		damage: "3d8+2",
		rof: 1,
		shots: "U",
	...
	{
		name: "Particle Accelerator, Medium",
		name_plural: "Particle Accelerators, Medium",
		classification: "Particle Accelerators",
		description: "Vehicular blasters fire a stream of charged particles (ions). Because the weapon fires a stream, a raise on the attack roll causes +2d6 damage instead of the usual 1d6. ",
		range: "100/200/400",
		damage: "4d8+2",
	...
	{
		name: "Particle Accelerator, Heavy",
		name_plural: "Particle Accelerators, Heavy",
		classification: "Particle Accelerators",
		description: "Vehicular blasters fire a stream of charged particles (ions). Because the weapon fires a stream, a raise on the attack roll causes +2d6 damage instead of the usual 1d6. ",
		range: "100/200/400",
		damage: "6d8+2",
